<article class="p-recommend__card splide__slide">
  <a class="p-recommend__link" href="<?php the_permalink(); ?>">
    <div class="p-recommend__wrapper">
      ...
      <figure class="c-card__thumbnail">
        <?php if (has_post_thumbnail()) : ?>
          <img src="<?php the_post_thumbnail_url('full'); ?>" width="960" height="693" decoding="async" loading="lazy" alt="<?php the_title_attribute(); ?>" />
        <?php else : ?>
